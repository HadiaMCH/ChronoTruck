...
class gestion_newsView extends Controller
{
    public function gestion_news($news){
        return (new acceuilAdminView)->headAdmin().(new acceuilAdminView)->navbarAdmin().$this->contenu($news).$this->scripts().$this->modals().(new acceuilAdminView)->modals().(new acceuilAdminView)->scripts();
    }
