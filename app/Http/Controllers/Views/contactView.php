...
class contactView extends Controller
{
    public function contact($contacts){
        return (new acceuilView)->headhome().(new acceuilView)->navbar().$this->contenu($contacts).(new acceuilView)->footer().(new acceuilView)->modal_login().(new acceuilView)->script_login();
    }
