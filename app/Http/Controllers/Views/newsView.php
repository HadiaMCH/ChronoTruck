...
class newsView extends Controller
{
    public function news($firstnews,$news){
        return (new acceuilView)->headhome().(new acceuilView)->navbar().$this->header().$this->contenu($firstnews,$news).(new acceuilView)->footer().(new acceuilView)->modal_login().(new acceuilView)->script_login();
    }
