...
class authView extends Controller
{
    public function inscription($wilayas,$statut_creation){
        return (new acceuilView)->headhome().(new acceuilView)->navbar().$this->header($statut_creation).$this->contenu($wilayas).$this->scripts().(new acceuilView)->footer().(new acceuilView)->modal_login().(new acceuilView)->script_login();
    }
